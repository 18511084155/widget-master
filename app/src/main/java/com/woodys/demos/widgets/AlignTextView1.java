package com.woodys.demos.widgets;
 ...
 * @author YD
 */
public class AlignTextView1 extends TextView {
    ...
    public AlignTextView1(Context context) {
        super(context);
        setTextIsSelectable(false);
    }

    public AlignTextView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        setTextIsSelectable(false);
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.AlignTextView1);

        int alignStyle = ta.getInt(R.styleable.AlignTextView1_align, 0);
        switch (alignStyle) {
            case 1:
